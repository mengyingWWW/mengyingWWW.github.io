...
<div style="max-width: 980px; margin: 0 auto;">
  <p style="opacity: 0.85; margin-top: 0;">
    <strong>Status:</strong> test01 Manuscript in preparation · <strong>Role:</strong> Research Assistant · <strong>Timeline:</strong> 2025–2026
  </p>
...
## Research Questions
- **RQ1:** How does AI interaction intensity affect cognitive load and engagement during reading?
- **RQ2:** How do reading patterns (e.g., gaze, regressions) change with different AI supports?
- **RQ3:** What trade-offs emerge between performance and experience?

## Approach
1–2 paragraphs:
- System / prototype (if any)
- Study design (conditions, tasks)
...
## Results (High-level)
Use bullets first (readable), then short paragraph.

- **Finding 1:** Placeholder summary (what changed, direction, effect).
- **Finding 2:** Placeholder summary.
